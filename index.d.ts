...
import { Order, Mode, float64ndarray, Shape2D } from '@stdlib/types/ndarray';
...
interface Float64Matrix {
	...
	* // returns [ 0, 0 ]
	*/
	new ( options?: Options ): float64ndarray;
	...
	* var getShape = require( '@stdlib/ndarray-shape' );
	*
	* var arr = new Float64Matrix( [ 2, 2 ] );
	* // returns <ndarray>
	*
	* var sh = getShape( arr );
	* // returns [ 2, 2 ]
	*/
	new ( shape: Shape2D, options?: Options ): float64ndarray;
	...
	* // returns [ 2, 2 ]
	*/
	new ( M: number, N: number, options?: Options ): float64ndarray;
	...
	* // returns [ 2, 2 ]
	*/
	new ( obj: ArrayLike<Collection<unknown> | AccessorArrayLike<unknown>> | Iterable<Collection<unknown> | AccessorArrayLike<unknown>>, options?: Options ): float64ndarray;
	...
	* var arr = new Float64Matrix( buf );
	* // returns <ndarray>
	*
	* var sh = getShape( arr );
	* // returns [ 1, 4 ]
	*/
	new ( buffer: ArrayBuffer, options?: Options ): float64ndarray;
	...
	*
	* var buf = new ArrayBuffer( 32 );
	* var arr = new Float64Matrix( buf, 8 );
	* // returns <ndarray>
	*
	* var sh = getShape( arr );
	* // returns [ 1, 3 ]
	*/
	new ( buffer: ArrayBuffer, byteOffset: number, options?: Options ): float64ndarray;
	...
	* // returns [ 2, 1 ]
	*/
	new ( buffer: ArrayBuffer, byteOffset: number, shape: Shape2D, options?: Options ): float64ndarray;
	...
	* // returns [ 2, 1 ]
	*/
	new ( buffer: ArrayBuffer, byteOffset: number, M: number, N: number, options?: Options ): float64ndarray;
	...
	* // returns [ 0, 0 ]
	*/
	( options?: Options ): float64ndarray;
	...
	* // returns [ 2, 2 ]
	*/
	( shape: Shape2D, options?: Options ): float64ndarray;
	...
	* // returns [ 2, 2 ]
	*/
	( M: number, N: number, options?: Options ): float64ndarray;
	...
	* // returns [ 2, 2 ]
	*/
	( obj: ArrayLike<Collection<unknown> | AccessorArrayLike<unknown>> | Iterable<Collection<unknown> | AccessorArrayLike<unknown>>, options?: Options ): float64ndarray;
	...
	* // returns [ 1, 4 ]
	*/
	( buffer: ArrayBuffer, options?: Options ): float64ndarray;
	...
	* // returns [ 1, 3 ]
	*/
	( buffer: ArrayBuffer, byteOffset: number, options?: Options ): float64ndarray;
	...
	* // returns [ 2, 1 ]
	*/
	( buffer: ArrayBuffer, byteOffset: number, shape: Shape2D, options?: Options ): float64ndarray;
	...
	* // returns [ 2, 1 ]
	*/
	( buffer: ArrayBuffer, byteOffset: number, M: number, N: number, options?: Options ): float64ndarray;
}
...
* // returns [ 2, 1 ]
*/
declare var ctor: Float64Matrix;
